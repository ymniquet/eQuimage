...
class ColorNoiseReductionTool(BaseToolWindow):
  ...
  def open(self, image):
    ...
    self.widgets.mixingscale = HScale(1., 0., 1., 0.01, digits = 2, marks = [0., 1.], length = 480, expand = False)
    ...
    self.widgets.thresholdscale = HScale(0., 0., 1., 0.01, digits = 2, marks = [0., 1.], length = 480, expand = False)
