...
class ColorNoiseReductionTool(BaseToolWindow):
  ...
  def open(self, image):
    ...
    self.widgets.mixingscale = HScale(1., 0., 1., 0.01, digits = 2, length = 464, expand = False)
    ...
    self.widgets.thresholdscale = HScale(0., 0., 1., 0.01, digits = 2, length = 464, expand = False)
